...
class MyProgram:
    ...
    def calculate(self):
        ...
        pre_emphasis = 0.97
        data_record = np.append(data_record[0],data_record[1:] -pre_emphasis * data_record[:-1])
        data_record = data_record * np.hamming(np.size(data_record))
        ...
        for item in recording_names:
            ...
            exec(exec1)
            exec1_5 = "data"+str(i)+" = np.append(data"+str(i)+"[0],data"+str(i)+"[1:] -pre_emphasis * data"+str(i)+"[:-1])"
            exec(exec1_5)
            exec1_7 = "data"+str(i)+" = data"+str(i)+" * np.hamming(np.size(data"+str(i)+"))"
            exec(exec1_7)
